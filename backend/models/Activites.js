...
const Activite = {
    ...
    create: (activite, callback) => {
        const sql = 'INSERT INTO activites_de_detente (nom_activite, description_activite, status_activite_détente, id_categorie, duree_minutes, sous_categorie) VALUES (?, ?, ?, ?, ?, ?)';
        db.query(sql, [activite.nom_activite, activite.description_activite, activite.status_activite_détente, activite.id_categorie, activite.duree_minutes, activite.sous_categorie], callback);
    },
