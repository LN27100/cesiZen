    ...
    <div class="info">
      ...
      <div class="info_container">
        ...
        <p>
          ...
          http://localhost:8080/ se réserve le droit de modifier unilatéralement et à tout moment le contenu des
          présentes CGU.
        </p>
  
        <h2>Article 1 : Les mentions légales</h2>
        <p>
          L’édition et la direction de la publication du site http://localhost:8080/ est assurée par Poirier-Halley
          Hélènee, domicilié 69 rue de la science 27100 Val de Reuil.
          Numéro de téléphone est 0602400216
          Adresse e-mail heloceinlove@laposte.net.
          L'hébergeur du site http://localhost:8080/ est la société Hostinger, dont le siège social est situé au
          Hostinger, UAB Jonavos g. 60C, 44192.
        </p>
  
        <h2>Article 2 : Accès au site</h2>
        <p>
          Le site http://localhost:8080/ permet à l'Utilisateur un accès gratuit aux services suivants :
          Le site internet propose les services suivants :
          Activités détente, gestion du stress
        ...
        <p>
          ...
          pas la responsabilité de http://localhost:8080/. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir
        ...
        <p>
          Les sources des informations diffusées sur le site http://localhost:8080/ sont réputées fiables mais le
          ...
          Malgré des mises à jour régulières, le site http://localhost:8080/ ne peut être tenu responsable de la
          ...
          Le site http://localhost:8080/ ne peut être tenu pour responsable d’éventuels virus qui pourraient
        ...
        <p>
          ...
          liens, il sortira du site http://localhost:8080/. Ce dernier n’a pas de contrôle sur les pages web sur
        ...
        <p>
          ...
          l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site http://localhost:8080/.
          ...
          L’information contenue dans les cookies est utilisée pour améliorer le site http://localhost:8080/.
